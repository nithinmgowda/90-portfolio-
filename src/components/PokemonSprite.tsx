...
const PokemonSprite: React.FC<PokemonSpriteProps> = ({ x, direction, onCollision, id, otherPositions }) => {
  ...
  const pokemonSprites = [
    '/src/assets/pokemon-sprites/pikachu-1.gif',
    '/src/assets/pokemon-sprites/charmander-1.gif',
    '/src/assets/pokemon-sprites/bulbasaur-1.gif',
    '/src/assets/pokemon-sprites/squirtle-1.gif'
  ];
